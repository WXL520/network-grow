...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion, steps=2, multiplier=4, stem_multiplier=3):
        ...
        #   self.cells += [cell]
        #   C_prev_prev, C_prev = C_prev, multiplier*C_curr  # multiplier=4是啥意思啊？？？
    ...
    def forward(self, input):
        ...
        weights = F.softmax(self.alphas_normal, dim=-1)
        s0, s1 = s1, self.cell(s0, s1, weights)  # 这里要改改，我希望cell有两个输出，两个节点分别输出自己的表示，而不是输出它们的平均值
