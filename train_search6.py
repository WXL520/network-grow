...
from model_search6 import Network, SubNetwork
...
def main():
    ...
    # genotypes = []
    # genotypes = [Genotype(normal=[('sep_conv_5x5', 1), ('sep_conv_5x5', 0), ('sep_conv_5x5', 2), ('sep_conv_3x3', 0)]),
    #              Genotype(normal=[('sep_conv_5x5', 2), ('dil_conv_5x5', 3), ('sep_conv_5x5', 4), ('sep_conv_3x3', 2)]),
    #              Genotype(normal=[('sep_conv_5x5', 4), ('dil_conv_5x5', 5), ('sep_conv_5x5', 6), ('sep_conv_3x3', 3)]),
    #              Genotype(normal=[('sep_conv_5x5', 6), ('sep_conv_3x3', 7), ('sep_conv_3x3', 8), ('sep_conv_3x3', 7)])]
...
def search_curr_genotype(genotypes, train_queue, valid_queue, criterion):
    ...
    # if len(genotypes) > 0:
    #     pretrained_model_dict = torch.load('subnet_weights.pt')
    ...
    # torch.save(model.state_dict(), 'supernet_weights.pt')
...
def train_searched_model(genotypes):
    ...
    # # if len(genotypes) > 2:
    # # 这里加载supernet的weights，然后就不需要训练100个epoch了吧？
    # pretrained_supernet_weights = torch.load('supernet_weights.pt')
    ...
    for epoch in range(args.subnet_epochs):
        ...
        if valid_acc > best_val_acc:
            ...
            # torch.save(model.state_dict(), 'subnet_weights.pt')
